...
This script converts HTML files from the ../html directory into attractive PDFs and EPUBs
using the academic-print.css stylesheet. It provides batch conversion capabilities and
...
- Pandoc integration for EPUB creation
- Progress tracking and detailed reporting
- CSS optimization for both print and digital formats
...
- pandoc: For EPUB generation (system package)

Usage:
    python convert_to_pdf_epub.py [--pdf-only] [--epub-only] [--output-dir OUTPUT]

Output:
    Creates PDF and/or EPUB files in the specified output directory
"""
...
def prepare_html_for_conversion(html_file_path: str, css_file_path: str, 
    ...
    """
    Prepare HTML file for conversion by adding CSS and optimizing structure.
    
    This function:
    1. Parses the HTML file
    2. Injects the academic CSS stylesheet
    3. Optimizes the document structure for PDF/EPUB
    4. Handles relative links and resources
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        for i, html_file in enumerate(html_files, 1):
            ...
            try:
                ...
                prepared_html = prepare_html_for_conversion(html_path, css_file)
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='Convert HTML files to PDF and EPUB formats')
